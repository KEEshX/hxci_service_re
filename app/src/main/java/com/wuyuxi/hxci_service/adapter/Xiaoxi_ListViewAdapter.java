...
public class Xiaoxi_ListViewAdapter extends BaseAdapter {
    public Context context;
    public ArrayList<HashMap<String,String>> list;
    public Xiaoxi_ListViewAdapter(Context context, ArrayList<HashMap<String,String>> list){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView==null){
            ...
            view=View.inflate(context, R.layout.xiaoxi_listview_item,null);
            //通过构造方法获取users布局的id
    ...
    class TestViewHolder{
        ...
        public TestViewHolder(View view){
            item_tongzhi=view.findViewById(R.id.xiaoxi_tongzhi);
            item_content=view.findViewById(R.id.xiaoxi_content);
            item_date=view.findViewById(R.id.xiaoxi_date);
        }
    }
}
